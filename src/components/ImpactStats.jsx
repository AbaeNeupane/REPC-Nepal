    ...
    <section className="bg-[#07163d] py-14">
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-8 text-center">
          <p className={`text-xs font-semibold uppercase tracking-[0.2em] text-amber ${lang === 'np' ? 'font-nepali' : ''}`}>
            {lang === 'en' ? 'Our impact' : 'हाम्रो प्रभाव'}
          </p>
          <h2 className={`mt-2 text-3xl font-bold text-white ${lang === 'np' ? 'font-nepali' : ''}`}>
            {lang === 'en' ? 'Building peaceful, just communities' : 'शान्तिपूर्ण र न्यायपूर्ण समुदाय निर्माण'}
          </h2>
        </div>
