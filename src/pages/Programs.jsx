...
const programs = [
  ...
  },
  {
    ...
    descEn: 'Regular  legal counselling sessions for vulnerable groups including women, children, elderly, and persons with disabilities.',
    descNp: 'महिला, बालबालिका, ज्येष्ठ नागरिक र अपाङ्गता भएका व्यक्ति सहित कमजोर समूहका लागि नियमित  कानुनी परामर्श सत्रहरू।',
    statusEn: 'Ongoing',
    statusNp: 'जारी',
    color: 'bg-cyan-700',
  },
